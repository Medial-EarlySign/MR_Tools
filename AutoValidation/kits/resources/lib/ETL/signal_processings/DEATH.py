#You have dataframe called "df". Please process it to generare signal "DEATH"
...
#Take only relevant data for DEATH - NOT NEEDED. Will be done by ETL infa
#df=df[df['signal']=='DEATH'].reset_index(drop=True)[['pid', 'signal', 'value_0']]
