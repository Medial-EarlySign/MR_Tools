...
#Test for parameters
REQ_PARAMETERS=['WORK_DIR', 'OUTCOME_INPUT_FILES_PATH']
...
all_signals='outcomes'
succ=prepare_final_signals(data_fetcher_file_api(OUTCOME_INPUT_FILES_PATH, batch_file_rows=very_big_file_split_by_rows), WORK_DIR,\
                      all_signals, batch_size=batch_sz, start_write_batch=999, editor = None, map_editor=None, override='n', interactive=False)
