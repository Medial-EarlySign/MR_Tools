...
REQ_PARAMS=(WORK_DIR SILENCE_RUN_INPUT_FILES_PATH) # Required parameters
...
#Store ETL directory next to "config", "Tests" - after testkit creation
python ${1}/../ETL/load.py "${1}" "${2}"
