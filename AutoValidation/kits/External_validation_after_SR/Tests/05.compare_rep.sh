...
MODEL_PATH=${FIRST_WORK_DIR}/model/model.medmdl
if [ ! -f ${WORK_DIR}/compare/compare_rep.txt ] || [ ${OVERRIDE} -gt 0 ]; then
...
if [ ! -f ${WORK_DIR}/compare.no_overfitting/compare_rep.txt ] || [ ${OVERRIDE} -gt 0 ]; then
