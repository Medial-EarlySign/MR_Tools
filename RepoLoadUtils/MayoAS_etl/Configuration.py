...
class Configuration:
    def __init__(self):
        ...
        self.data_path = '/nas1/Data/Mayo_AS'
        self.work_path = '/nas1/Work/Users/coby/MayoAS/'
        self.work_dir = '/nas1/Work/Users/coby/MayoAS/'
        self.tools_path = f'/nas1/UsersData/{username}/MR/Tools'
        self.code_path = os.path.join(self.tools_path,'RepoLoadUtils','MayoAS_etl')
        self.code_dir = os.path.join(self.tools_path,'RepoLoadUtils','MayoAS_etl')
