...
class Configuration:
    def __init__(self):
		...
		self.code_folder = 'H:\\MR\\Tools\\RepoLoadUtils\\thin_etl\\config_2017'
		...
		#self.output_path = '/server/Work/Users/Barak/hyper/' # path to output graphs and information abput signals. in linux it's mapped automaticaly "C:\\Users\\Alon" is replaced by "~\"
