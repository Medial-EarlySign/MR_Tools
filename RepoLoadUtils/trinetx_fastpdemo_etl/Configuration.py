...
class Configuration:
    def __init__(self):
        ...
        self.repo_folder = '/server/Work/Repositories/TrinetX_fastpdemo/'
        ...
        self.work_path = '/nas1/Work/Users/ilya/Trinetx/'
        self.work_dir = '/nas1/Work/Users/ilya/Trinetx/'
        self.tools_path = f'/nas1/UsersData/{username}/MR/Tools'
        self.code_path = os.path.join(self.tools_path,'RepoLoadUtils','trinetx_fastpdemo_etl') 
        self.code_dir = os.path.join(self.tools_path,'RepoLoadUtils','trinetx_fastpdemo_etl')   
