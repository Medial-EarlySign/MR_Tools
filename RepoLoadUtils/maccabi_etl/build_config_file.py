...
def add_const_lines():
    cons_list = ['#', '# convert config file', '#', 'DESCRIPTION\tMACCABI data - full version',
                 'RELATIVE \t1', 'SAFE_MODE\t1', 'MODE\t3', 'PREFIX\tmaccabi_rep', 'CONFIG\tmaccabi.repository',
                 'SIGNAL\tmaccabi.signals', 'FORCE_SIGNAL\tGENDER,BYEAR',
                 'DIR\t/data/maccabi_load/rep_configs',
                 'OUTDIR\t/data/Repositories/sep2019'
                 ]
    return cons_list
...
if __name__ == '__main__':
    ...
    out_file = os.path.join(config_folder, 'maccabi.convert_config')
