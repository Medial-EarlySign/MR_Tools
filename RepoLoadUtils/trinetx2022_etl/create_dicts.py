...
def create_diagnosis_dict(onto_path,in_path,dict_path,err_file):
    ...
    # Copy dictionaries
    dicts = (('ICD9','dict.icd9dx'), ('ICD9','dict.set_icd9dx'), ('ICD9','dict.icd9sg'), ('ICD9','dict.set_icd9sg'), ('ICD10','dict.icd10'), ('ICD10','dict.set_icd10'), ('ICD10_TO_ICD9','dict.set_icd10_2_icd9'),
             ('CPT','dict.cpt'),('HCPCS','dict.hcpcs'))
